...
const Terms = () => {
    return (
        <div className="flex flex-col items-left min-h-screen p-4">
            ...
            <p>You agree to use Listable only for lawful purposes and in compliance with all applicable laws and regulations.</p><br></br>

            <p><b>2. User Accounts</b></p>
            <p>To access some features of Listable, you may need to create an account. You are responsible for maintaining the confidentiality of your account and password and for all activities that occur under your account.</p><br></br>

            <p>You agree to provide accurate, complete, and current information when creating your account and to update such information as needed.</p><br></br>

            <p><b>3. Your Content</b></p>
            <p>Listable allows you to create, store, and manage content (like lists, notes, and tasks). You retain all rights to the content you create, but by uploading or submitting it to the Service, you grant Listable a non-exclusive, royalty-free license to use, store, and display it solely to operate and improve the Service.</p><br></br>

            <p>You are solely responsible for the content you submit. Do not post or share anything that is unlawful, harmful, or violates the rights of others.</p><br></br>

            <p><b>4. Prohibited Conduct</b></p>
            <p>You agree not to:</p>

            <p>&bull;&nbsp;Use the Service for any illegal or unauthorized purpose</p>

            <p>&bull;&nbsp;Attempt to gain unauthorized access to other accounts or systems</p>
            ...
            <p>Email: support@listable.com</p>
        </div>
    )
}
